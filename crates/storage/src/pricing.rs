...
impl PricingConfig {
    ...
    pub fn calculate_total_cost(
        ...
        self.calculate_invocation_cost(invocations)
            + self.calculate_compute_cost(memory_mb, execution_time_ms)
    }
}
...
impl PricingManager {
    ...
    pub async fn update_pricing(
        ...
        let current_version: i32 =
            sqlx::query_scalar("SELECT COALESCE(MAX(version), 0) FROM pricing_config")
                .fetch_one(&self.pool)
                .await?;
